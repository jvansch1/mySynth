...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var $instructions = [$instructionsOne, $instructionsTwo, $instructionsThree, $instructionsFour, $instructionsFive];
  var currentWindow = 0;
  ...
  presetOneButton.addEventListener('click', function () {
    ...
    _tuna.delay.delayTime.value = 0.4;
