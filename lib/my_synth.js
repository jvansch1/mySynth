...
document.addEventListener('DOMContentLoaded', function () {
  ...
  newCutoff.addEventListener("change", function () {
    var newCutoffNumber = parseInt(newCuaetoff.value);
...
function connectNodes(osc, osc2) {
  ...
  envelope.gain.linearRampToValueAtTime(masterGainNode.gain.volume, _audioCtx2.default.currentTime + attack / 1000);
