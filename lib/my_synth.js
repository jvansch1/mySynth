...
/***/function (module, exports, __webpack_require__) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var newDryAmount = document.getElementById('reverb-dry-slider');
    newDryAmount.addEventListener("change", function () {
      var newDryNumber = parseFloat(newDryAmount.value.match(/[\d\.]+/));
      _tuna.convolver.dry.gain.value = newDryNumber;
    });
